...
<script>
    ...
    document.getElementById('scatterWrapper').appendChild(renderer.domElement);
...
//    renderer.setClearColorHex(0xEEEEEE, 1.0);
    ...
    var data = d3.csv("<?php bloginfo('template_url');?>/defaultData.csv", function (d) {
