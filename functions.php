...
function shwib_additional_setup() {
	...
	require_once( trailingslashit( TEMPLATEPATH ) . '/modules/admin.php' );
	require_once( trailingslashit( TEMPLATEPATH ) . '/modules/PostTypes.php' );
	require_once( trailingslashit( TEMPLATEPATH ) . '/modules/Taxonomies.php' );
	require_once( trailingslashit( TEMPLATEPATH ) . '/modules/mediathek.php' );
}	
